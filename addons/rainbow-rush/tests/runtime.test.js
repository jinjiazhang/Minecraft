...
function harness(){
 ...
 vm.runInContext(source+'\nglobalThis.api={fillSegment,mine,interact,exchange,flush,held,round:()=>round,enable(r){round=r;ready=true},data};',ctx);ctx.api.enable(currentRound);
