...
write(ROOT/'resource_pack/manifest.json',{'format_version':2,'header':{'name':'星露谷 · 顶部状态栏','description':'日期、天气、金币与体力置顶','uuid':RP_UUID,'version':[1,1,0],'min_engine_version':[1,26,30]},'modules':[{'type':'resources','uuid':'4ef39d5a-d88e-49c2-b2a6-bb05db5998c2','version':[1,1,0]}]})
p=ROOT/'pack/manifest.json'
data=json.loads(p.read_text(encoding='utf-8'));data['dependencies'].append({'uuid':RP_UUID,'version':[1,1,0]});write(p,data)
