...
export const GOODS={wood:{name:'木材',sell:2},stone:{name:'石头',sell:2},copper:{name:'铜矿石',sell:5},iron:{name:'铁矿石',sell:10},gold:{name:'金矿石',sell:25},fish:{name:'沙丁鱼',sell:40},carp:{name:'鲤鱼',sell:30},leek:{name:'韭葱',sell:60},egg:{name:'鸡蛋',sell:50},milk:{name:'牛奶',sell:125}};
